...
const SENSITIVE_KEY = /(password|passwd|secret|token|authorization|api[_-]?key|apikey|card|cvv|cvc|signature|jwt|bearer|connectionstring|databaseurl|database_url|postgres|\bpin\b|_pin)/i;
